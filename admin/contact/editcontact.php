            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php">Lihat Contact</a>
                        <a class="collapse-item" href="inputcontact.php">Input Contact</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php 
                        ...
                        $id=$_GET['id'];
                        $koleksi = mysqli_query($koneksi, "SELECT `id_contact`, `contact` FROM `contact` WHERE id_contact='$id'");
                        $contactt = mysqli_fetch_array($koleksi);
                        $id=$contactt['id_contact'];
                        $contact = $contactt['contact'];
                    ?>
                    <div class="container">
                        <form action="proses-editcontact.php" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="contact">Contact Restaurant</label>
                                    <input type="text" class="form-control" value="<?php echo $contactt['id_contact'] ?>" name="id_contact" hidden>
                                    <input value="<?php echo $contactt['contact']?>" type="text" class="form-control" id="contact" name="contact" placeholder="Contact Restaurant" required>
                                </div>
                            </div>
