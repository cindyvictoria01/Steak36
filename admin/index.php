            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="menu/">Lihat Menu</a>
                        <a class="collapse-item" href="menu/inputmenu.php">Input Menu</a>
                        <a class="collapse-item" href="event/">Lihat Event</a>
                        <a class="collapse-item" href="event/inputevent.php">Input Event</a>
                        <a class="collapse-item" href="contact/">Lihat Contact</a>
                        <a class="collapse-item" href="contact/inputcontact.php">Input Contact</a>
                        <a class="collapse-item" href="rsvp/">Lihat Reservation</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
