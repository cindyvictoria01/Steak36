            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php 
                        ...
                        $id=$_GET['id'];
                        $koleksi = mysqli_query($koneksi, "SELECT `id_menu`,`nama_menu`, `deskripsi`, `harga`, `kategori`, `gambar`,`addition` FROM `menu` WHERE id_menu='$id'");
                        ...
                        $addition = $menu['addition'];
                    ?>
                    <!-- Page Heading -->
                    <!-- <h1 class="h3 mb-4 text-gray-800"></h1> -->
                    <div class="container">
                        <form action="proses-editmenu.php" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="nama_menu">Judul Menu</label>
                                    <input type="text" class="form-control" value="<?php echo $menu['id_menu'] ?>" name="id_menu" hidden>
                                    <input type="text" class="form-control" id="nama_menu" name="nama_menu" placeholder="Judul Menu" required value="<?php echo $menu['nama_menu']; ?>">
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor" id="ckedtor" name="deskripsi"><?php echo $menu['deskripsi']; ?></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori" class="form-control">
                                    <option selected>Selected : <?php echo $menu['kategori']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="addition" class="form-control">
                                    <option selected>Selected : <?php echo $menu['addition']; ?></option>
