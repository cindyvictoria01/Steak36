            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../event/index.php">Lihat Event</a>
                        <a class="collapse-item" href="../event/inputevent.php">Input Event</a>
                        ...
                        <a class="collapse-item" href="index.php">Lihat Reservation</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php 
                        ...
                        $id=$_GET['id'];
                        $koleksi = mysqli_query($koneksi, "SELECT `id`, `fldName`, `fldDateTime`, `fldEmail`, `fldGuest`, `fldPhone` FROM `tbl_reservation` WHERE id='$id'");
                        $rsvp = mysqli_fetch_array($koleksi);
                        $id=$rsvp['id'];
                        $fldName = $rsvp['fldName'];
                        $fldDateTime = $rsvp['fldDateTime'];
                        $fldEmail = $rsvp['fldEmail'];
                        $fldGuest = $rsvp['fldGuest'];
                        $fldPhone = $rsvp['fldPhone'];
                    ?>
                    <!-- Page Heading -->
                        ...
                        <form action="proses-edit.php" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="fldName">Nama Pemesan</label>
                                    <input type="text" class="form-control" value="<?php echo $rsvp['id'] ?>" name="id" hidden>
                                    <input type="text" class="form-control" id="fldName" name="fldName" placeholder="Nama Pemesan" required value="<?php echo $rsvp['fldName']; ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="fldDateTime">Date&Time</label>
                                    <input type="text" class="form-control" id="fldDateTime" value="<?php echo $rsvp['fldDateTime']; ?>" placeholder="Date&Time" name="fldDateTime">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputDesc">Email</label>
                                <input type="email" class="form-control" id="fldEmail" name="fldEmail" placeholder="Email" required value="<?php echo $rsvp['fldEmail']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="fldGuest">Guest</label>
                                <input type="number" class="form-control" id="fldGuest" placeholder="Guest" name="fldGuest" value="<?php echo $rsvp['fldGuest']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="fldPhone">Number Phone</label>
                                <input type="number" class="form-control" id="fldPhone" placeholder="Number Phone" name="fldPhone" value="<?php echo $rsvp['fldPhone']; ?>">
                            </div>
